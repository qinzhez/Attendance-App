(function () {
    ...
    RoomListController.$inject = ['$q','RoomService', 'AuthenticationService', 'FlashService', '$scope', 'StateService'];
    function RoomListController($q, RoomService, AuthenticationService, FlashService, $scope, StateService) {
